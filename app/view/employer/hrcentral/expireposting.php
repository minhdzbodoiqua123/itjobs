  ...
  <div class="container">
    ...
    <div class="main-wrap">
      <div class="left-wrap">         <ul class="list-menu">
          ...
          <?= _WEB_ROOT.'employer/hrcentral/posting' ?>
          <li class="active"> <a href="https://careerbuilder.vn/vi/employer/hrcentral/posting" title="Quản Lý Đăng Tuyển">Quản Lý Đăng Tuyển</a> </li>
