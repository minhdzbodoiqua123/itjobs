                                    ...
                                    <div class="main-form">
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Vui lòng nhập email của bạn" type="text" name="email" id="email" value="" autocomplete="off" class="form-control" placeholder="Vui lòng nhập thông tin">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Vui lòng nhập mật khẩu" data-pristine-pattern= "/^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9]).{8,}$/" data-pristine-pattern-message="Tối thiểu 8 ký tự, ít nhất một chữ hoa, một chữ thường và một số" type="password" class="form-control" name="password" id="password" value="">
                                               </div>
                                        </div>
                                        <div class="form-group d-flex">
                                            <div class="form-info"> <span>Xác nhận mật khẩu</span> </div>
                                            <div class="form-input">
       <input  data-pristine-equals="#password" data-pristine-equals-message="Mật khẩu nhập không khớp. Vui lòng thử lại." name="re_password" id="re_password" type="password" value="" class="form-control">
                                                </span>
                                             </div>
                                        </div>
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Không được để trống" type="text" name="company_name" id="company_name" value="" class="form-control" placeholder="Vui lòng nhập thông tin">
                                              </div>
                                        </div>
                                        <div class="form-group d-flex">
                         ...
                         <div class="form-info"> <span id="lable_location">Tỉnh / TP</span> </div>
                                        ...
                                        <div class="form-group d-flex">
                         <div class="form-info"> <span >Quận / Huyện</span> </div>
                                            <div class="form-input short form-input-select">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Không được để trống" type="text" name="company_address" id="company_address" value="" class="form-control" placeholder="Vui lòng nhập thông tin">
                                        ...
                                        <div class="form-group d-flex info-company">
                                            ...
                                            <div class="form-input">
                                                <textarea required data-pristine-required-message="Không được để trống" class="form-control" rows="5" name="company_summary" id="company_summary"></textarea>
                                                <span class="form-error error_company_summary">  </span> </div>
                                            <div class="noti"><em class="material-icons">error</em>
                                                <div class="toolip">
                                                    <p> <strong>Gợi ý</strong></p>
                                                    <p>Giới thiệu thông tin về công ty là cách tốt nhất làm nổi bật công ty của Quý khách trước các ứng viên tiềm năng. Một bản sơ lược tốt về công ty sẽ gây ấn tượng đối với ứng viên, khiến họ chọn công ty
                                                        của Quý khách làm nơi phát triển nghề nghiệp lâu dài.</p>
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Không được để trống" type="text" name="contact_name" id="contact_name" value="" class="form-control" placeholder="Vui lòng nhập thông tin">
                                                <span class="form-error error_contact_name">  </span> </div>
                                        </div>
                                        <div class="form-group d-flex">
                                            <div class="form-info"> <span>Điện thoại</span> </div>
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Không được để trống" type="text" name="contact_phone" id="contact_phone" value="" class="form-control" placeholder="Vui lòng nhập thông tin">
                                                <span class="form-error error_contact_phone">  </span> </div>
                                        </div>
                                        <div class="form-group d-flex">
                                            <div class="form-info"> <span>Mã số thuế</span> </div>
                                            <div class="form-input">
                                                <input required data-pristine-required-message="Không được để trống" type="text" name="taxid" id="taxid" value="" class="form-control" placeholder="Vui lòng nhập mã số thuế">
