...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Sửa phúc lợi</h3>
          <div class="tile-body">
            ...
            <form id="formUpdate" method="post" action="" class="row">
              ...
              <div class="form-group col-md-12">
                ...
                <input value="<?= $datajob_welfareById["welfare_type"] ?>" class="form-control" name="welfare_type" type="text">
                <small></small>
                <span></span>
              </div>
             ...
             <img style="margin:15px 0;" height="400" width="400" src="<?=  "http://localhost//itjobs/app/public/assets/admin/images/".$_SESSION['admin']['image']?>" id="thumbimage" class="preview d-none" alt="Image preview">
             </div>
                  <small></small>
                  <span></span>
            </div> -->
              ...
              <div class="form-group col-md-12">
                ...
                <a class="btn btn-cancel" href="http://localhost//itjobs/admin/jobwelfare">Hủy bỏ</a>
              </div>
            </form>
          </div>
