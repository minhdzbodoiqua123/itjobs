                                    ...
                                    <div class="widget-head">
                                        <div class="cb-title-h3">
                                            ...
                                            <div class="right-action">
                                                ...
                                                <div class="link-edit">
                                                    <a  data-bs-toggle="modal" data-bs-target="#thongtincanhan" 
                                                     href="javascript:void(0);" > <em class="material-icons">create</em>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group form-radio">
                ...
                <span class="err_gender" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
              <div class="form-group form-birthday">
                <label for="">* Ngày sinh</label>
                <input type="text"  class="date_month" name="birthday" ">
                <div id="date_time_picker" class="dtpicker-overlay dtpicker-mobile"><div class="dtpicker-bg">
                    
                <div class="dtpicker-cont"><div class="dtpicker-content"><div class="dtpicker-subcontent"></div>
            
            </div></div></div></div>
                <span class="err_birthday" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
              <div class="form-group form-text">
              <label for="">* Số điện thoại</label>
                ...
                <span class="err_mobile" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
                <div class="form-group form-text">
...
<option value="20">Người Đài Loan</option>
                ...
                <span class="err_slnationality" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
              <div class="form-group form-select">
               ...
               <select name="slMarritial">
                ...
                <span class="err_slMarritial" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
              <div class="form-group form-select">
...
<option value="20">Đài Loan</option>
                ...
                <span class="err_slcountry" style="display:none"></span></div>
            </div>
            <div class="col-md-6">
              <div class="form-group form-select">
				...
				<option value="">Chọn</option><option value="4">Hà Nội</option><option value="8">Hồ Chí Minh</option><option value="76">An Giang</option><option value="64">Bà Rịa - Vũng Tàu</option><option value="781">Bạc Liêu</option><option value="281">Bắc Cạn</option></select>
                <span class="err_slcity" style="display:none"></span> </div>
            </div>
            <div class="col-md-6"> <!--id="areaDistrict"-->
              <div class="form-group form-select">
                <label for="">* Quận/huyện</label>
				<select name="sldistrict" id="sldistrict" class="select-district">
					
				 <option value="">Chọn</option><option value="347">Huyện Ba Vì</option><option value="353">Huyện Chương Mỹ</option><option value="349">Huyện Đan Phượng</option><option value="339">Huyện Đông Anh</option><option value="340">Huyện Gia Lâm</option><option value="350">Huyện Hoài Đức</option><option value="344">Huyện Mê Linh</option><option value="358">Huyện Mỹ Đức</option><option value="357">Huyện Ứng Hòa</option><option value="356">Huyện Phú Xuyên</option><option value="348">Huyện Phúc Thọ</option><option value="351">Huyện Quốc Oai</option><option value="338">Huyện Sóc Sơn</option><option value="352">Huyện Thạch Thất</option><option value="354">Huyện Thanh Oai</option><option value="342">Huyện Thanh Trì</option><option value="355">Huyện Thường Tín</option><option value="329">Quận Ba Đình</option><option value="343">Quận Bắc Từ Liêm</option><option value="333">Quận Cầu Giấy</option><option value="334">Quận Đống Đa</option><option value="345">Quận Hà Đông</option><option value="335">Quận Hai Bà Trưng</option><option value="330">Quận Hoàn Kiếm</option><option value="336">Quận Hoàng Mai</option><option value="332">Quận Long Biên</option><option value="341">Quận Nam Từ Liêm</option><option value="331">Quận Tây Hồ</option><option value="337">Quận Thanh Xuân</option><option value="346">Thị xã Sơn Tây</option></select>
                <span class="err_sldistrict" style="display:none"></span> </div>
            </div>
            <div class="col-md-6">
            <label for="">* Địa chỉ (Số nhà, Đường)</label>
              <div class="form-group form-text">
                ...
                <span class="err_address" style="display:none"></span></div>
            </div>
          </div>
          <div class="modal-footer">
