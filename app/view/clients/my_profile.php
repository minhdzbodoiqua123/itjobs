                    ...
                    <div class="db-my-profile">
                        <div class="row">
                            <div class="col-lg-8 col-xl-9 main-widget">
                                                ...
                                                <div id="complete_section">
                                                    ...
                                                    <div class="searchable-cv-widget status-area attached-status-area">
                                                        <div class="switch-status group_searchable" id="cv_searchable_17611557" data-id="17611557" data-complete="0">
                                                            <a href="javascript:void(0);" data-type="2" class="lock active" style="border-radius: 21px;text-align: center;"><em class="mdi mdi-lock"></em>Khóa</a>
                                                            <a href="javascript:void(0);" data-type="1" class="public " style="text-decoration:none;border-radius: 21px;text-align: center;"><em class="mdi mdi-web"></em>Công khai</a>
                                                            <a href="javascript:void(0);" data-type="3" class="flash " style="text-decoration:none;border-radius: 21px;text-align: center;"><em class="mdi mdi-flash"></em>Khẩn cấp</a>
                                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <form autocomplete="on" name="t-resume-form" id="t-resume-form">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Lưu lại</button>
                                                        </div>
                                                    </form>
                                ...
                                <div class="modal fade" id="thongtincanhan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group form-text">
                                                                ...
                                                                <input type="text" onkeyup="this.setAttribute('value', this.value);" name="lastname" id="lastname" value="Một" maxlength="30" class="valid">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group form-text">
                                                                <label>* Tên</label>
                                                                <input type="text" onkeyup="this.setAttribute('value', this.value);" name="firstname" id="firstname" value="Ba" maxlength="30">
                ...
                <div id=" date_time_picker" class="dtpicker-overlay dtpicker-mobile">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-text">
                                                            ...
                                                            <input type="text" onkeyup="this.setAttribute('value', this.value);" name="mobile" id="mobile" value="0839704123" maxlength="20" style="margin-top:5px">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-text">
                                                            ...
                                                            <input type="text" onkeyup="this.setAttribute('value', this.value);" id="email_member_edit" value="aolang69@gmail.com" readonly="readonly" disabled="disabled" style="margin-top:5px">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group form-text">
                                                            <input type="text" onkeyup="this.setAttribute('value', this.value);" name="address" value="đường 7">
                                            ...
                                            <div class="modal-footer">
                                                <div class="button-save button-center">
                                                    <button class="btn-primary" type="button">Lưu lại</button>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
                                ...
                                <div class="widget-head">
                                    <div class="cb-title-h3">
                                        ...
                                        <div class="right-action">
                                            ...
                                            <div class="link-edit"><a href="javascript:void(0);" onclick="editResumeObjective();"> <em class="material-icons">create</em><span>Thêm mới</span></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-body">
...
<div class="modal fade" id="thongtingnghenghiep" tabindex="-1" " aria-hidden="true">
            ...
            <div class="col-lg-8">
              <div class="form-salary">
                ...
                <div class="form-select form-text">
				  ...
				  <input placeholder="Từ *"off" type="text" size="12" name="salary_from" id="salary_from" onkeyup="this.setAttribute('value', this.value);" maxlength="14" value="1000000">
                </div>
                <div class="form-select form-text">
               
				  <input  placeholder="Đến *"autocomplete="off" type="text" onkeyup="this.setAttribute('value', this.value);" size="12" name="salary_to" id="salary_to" maxlength="14" value="2000000">
                </div>
              </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-8">
              <div class="form-select-chosen">
                <select class="chosen-select-max-three" name="INDUSTRY_ID[]" id="INDUSTRY_ID" data-placeholder="Ngành nghề">
										...
										<option value="45">Mới tốt nghiệp / Thực tập</option>
										                </select><div class="chosen-container chosen-container-multi" title="" id="INDUSTRY_ID_chosen" style="width: 0px;">
                                                        
                                                        <!-- <ul class="chosen-choices">
  <li class="search-choice"><span>Công nghệ thực phẩm / Dinh dưỡng</span><a class="search-choice-close" data-option-array-index="39"></a></li><li class="search-field">
    <input class="chosen-search-input" type="search" autocomplete="off" value="Ngành nghề" style="width: 25px;">
  </li>
</ul> -->
				...
				<div class="list-work-popup">
					<div class="work-popup-item active">
						<div class="row">
							...
							<div class="col-6 col-cus-6-5">
								<div class="form-select-chosen form-select-district">
									<select name="DISTRICT_ID[]" id="select_district_id_3" data-placeholder="Quận" class="chosen-select-max-three" multiple="" style="display: none;">
									<option value="-1;4">All</option><option value="347;4">Huyện Ba Vì</option><option value="353;4">Huyện Chương Mỹ</option><option value="349;4">Huyện Đan Phượng</option><option value="339;4">Huyện Đông Anh</option><option value="340;4">Huyện Gia Lâm</option><option value="350;4">Huyện Hoài Đức</option><option value="344;4">Huyện Mê Linh</option><option value="358;4">Huyện Mỹ Đức</option><option value="357;4">Huyện Ứng Hòa</option><option value="356;4">Huyện Phú Xuyên</option><option value="348;4">Huyện Phúc Thọ</option><option value="351;4">Huyện Quốc Oai</option><option value="338;4">Huyện Sóc Sơn</option><option value="352;4">Huyện Thạch Thất</option><option value="354;4">Huyện Thanh Oai</option><option value="342;4">Huyện Thanh Trì</option><option value="355;4">Huyện Thường Tín</option><option value="329;4">Quận Ba Đình</option><option value="343;4">Quận Bắc Từ Liêm</option><option value="333;4">Quận Cầu Giấy</option><option value="334;4">Quận Đống Đa</option><option value="345;4">Quận Hà Đông</option><option value="335;4">Quận Hai Bà Trưng</option><option value="330;4">Quận Hoàn Kiếm</option><option value="336;4">Quận Hoàng Mai</option><option value="332;4">Quận Long Biên</option><option value="341;4">Quận Nam Từ Liêm</option><option value="331;4">Quận Tây Hồ</option><option value="337;4">Quận Thanh Xuân</option><option value="346;4">Thị xã Sơn Tây</option>
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="form-select-chosen form-select-district">
                                    ...
                                    <div class="chosen-container chosen-container-multi" title="" id="select_district_id_1_chosen" style="width: 0px;"><ul class="chosen-choices">
...
<div class="chosen-drop">
  <ul class="chosen-results"></ul>
							...
							<div class="col-2 col-cus-1-3">
								<div class="delete"><a href="javascript:void(0);" onclick="return RemoveRowLoc(this, 1);"> <em class="material-icons">highlight_off</em></a></div>
							</div>
						</div>
					</div>
					<div class="work-popup-item ">
						<div class="row">
							...
							<div class="col-6">
								<div class="form-select-chosen form-select-district">
									...
									</select><div class="chosen-container chosen-container-multi" title="" id="select_district_id_2_chosen" style="width: 0px;"><ul class="chosen-choices">
  <!-- <li class="search-field">
    <input class="chosen-search-input default" type="search" autocomplete="off" value="Quận" style="width: 62.3625px;">
  </li> -->
</ul>
<div class="chosen-drop">
  <ul class="chosen-results"></ul>
							...
							<div class="col-2 col-cus-1-3">
								<div class="delete"><a href="javascript:void(0);" onclick="return RemoveRowLoc(this, 2);"> <em class="material-icons">highlight_off</em></a></div>
							</div>
						</div>
					</div>
					
				</div>
				<!-- <div class="add-work-popup"><a href="javascript:void(0);" onclick="addListWorkPopup();"> <em class="material-icons">add </em><span>Thêm</span></a></div> -->
            </div>
          </div>
	  ...
	  <div class="form-group row">
		...
		<select multiple search="true" name="BENEFIT_ID[]" id="BENEFIT_ID" class="chosen-select-max-three" data-placeholder="Chọn" title="Chọn" >
   	  ...
   	  <textarea name="objective_job" id="objective_job" style="display:none"></textarea>
          <div class="form-group form-button">
            <div class="button-save button-center">
              <button class="btn-gradient" type="button" data-bs-dismiss="modal">Lưu Lại</button>
            </div>
          </div>
        </form>
      </div>
                            ...
                            <div class="widget widget-16" id="certificate-section">
                                ...
                                <div class="widget-body">
                                    <div class="no-content">
                                        <p>Vui lòng nhập chứng chỉ</p><a href="javascript:void(0)" onclick="editResumeCertificate(0);"><em class="mdi mdi-plus-circle"></em><span>Thêm mới</span></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget widget-23 widget-15" id="other-activity-section">
                                ...
                                <div class="widget-body">
                                    <div class="no-content">
                                        <p>Mô tả hoạt động</p><a href="javascript:void(0)" onclick="editResumeActivity(0);"><em class="mdi mdi-plus-circle"></em><span>Thêm mới</span></a>
                                    </div>
                                </div>
                            ...
                            <div class="menu-shortchut">
                                <div class="list-button">
                                    <ul>
                                        ...
                                        <li id="btn_download" style="display:none"> <a href="javascript:void(0);" onclick="downloadCvProfile(17611557)"> <em class="material-icons">get_app</em><span>Tải hồ sơ</span></a>
                                        </li>
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="content">
                                                <p>Phông chữ trong CV phần nào thể hiện phong thái của bạn khi làm việc và Nhà tuyển dụng thường mong muốn được đọc các thông tin bạn đưa ra ở một cỡ chữ vừa phải, rõ ràng, không quá to cũng không quá nhỏ.
                                                    Cỡ chữ gợi ý cho một CV chuẩn là tầm 12 đến 14 và bạn có thể kiểm tra thử bằng cách in CV ra trên khổ giấy A4 trước khi gửi đi ứng tuyển nhé.</p>
                                            </div>
                                        </div>
                                    </div>
