...
<head>
   ...
   <link rel="stylesheet" href="<?php echo _WEB_ROOT;?>/app/public/assets/errors/css/404.css">
...
<main>
 <svg
  ...
  <button id="errorLink" href="">Go Back</butt>
</main>
<script>
 
 const errorLink=document.getElementById("errorLink");
      errorLink.onclick=function () {
           window.location.href="<?php echo _WEB_ROOT ?>";
      }
</script>
</body>
</html>